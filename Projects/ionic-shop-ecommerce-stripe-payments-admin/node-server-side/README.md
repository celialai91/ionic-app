...
To run this package, make sure that NODEJS is installed in your workspace.
Then run:
...
This will install all the files required. Then run:
...
Send an XMLHttpRequest To the location of your server/workspace with `/charge`. We recommend that you upload the files to a VPS such as Heroku or Cloud9.
